...
def simulated_attack(inputs):
    contexts = {"pool1": brief_context(context1),
                "pair": brief_context(context2)}
    return simulated_attack2(inputs, targets, contexts)
...
with Pool(processes=os.cpu_count(), ) as p:
    ...
    while amount_a1 <= max_attack1:
        ...
        result = p.starmap(simulated_attack, params, chunksize=100) #(inputs, targets, contexts, step=2)
